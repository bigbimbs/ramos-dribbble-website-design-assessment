export const FastEasy = () => {
  return (
    <div className="col-span-3 shadow-xl border rounded-2xl pl-4 pt-4 grid grid-cols-2 bg-white">
      ...
      <div className="col-span-1 border-s border-t rounded-ss-lg p-4">
        ...
        <div className="grid grid-cols-5 items-center mt-3">
          <div className="flex gap-5 items-center col-span-3">
            <div className="w-10 h-10 bg-[#FE4A23] rounded-full"></div>
            <div className="">
        ...
        <div className="p-2 border rounded-xl mt-3 h-40 relative">
